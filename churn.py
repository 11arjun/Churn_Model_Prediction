...
# Loading Dataset
data = pd.read_csv('7 churn.csv')
# Removing the unwanted Independent variable 
data = data.drop(['customerID'], axis=1)
# Label Encoding useful Columns 
label_encoder = LabelEncoder() 
category_cols = ['gender', 'PaperlessBilling','Dependents','SeniorCitizen','Contract','Partner', 'PhoneService','MultipleLines','DeviceProtection','Churn', 'PaymentMethod', 'OnlineSecurity','InternetService','TechSupport','OnlineBackup',
...
log_reg = LogisticRegression(random_state=42, max_iter=3000,penalty='l2', C = 0.001)
